# EXPERIMENT 4:INTERFACING AN 16X2 LCD DISPLAY WITH ARM AND DISPLAY STRING
### DATE:22-09-2025
...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,1);
  Lcd_string(&lcd, "ADITYA S");
  HAL_Delay(500);
  Lcd_cursor(&lcd, 1,1);
  Lcd_string(&lcd, "212223040007");
  HAL_Delay(500);
  while (1)
  {
  }
...
## Output screen shots of proteus  :
 <img width="1919" height="1018" alt="image" src="https://github.com/user-attachments/assets/9caf62fb-9901-44b7-a82b-fb942468459f" />
